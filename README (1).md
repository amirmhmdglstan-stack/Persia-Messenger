...
### نصب yt-dlp (برای دانلودر ویدیو — اختیاری)
دانلودر برای لینک‌های ویدیویی (یوتیوب و...) به **yt-dlp** روی سرور نیاز دارد:

```bash
# روی سرور (مثلاً Render از طریق Start Command یا apt)
pip install -U yt-dlp      # یا: apt-get install -y yt-dlp
```

- اگر yt-dlp نصب نباشد، دانلودر برای **لینک مستقیم** `.mp4`/`.mp3`/... کار می‌کند و برای لینک‌های ویدیویی پیام راهنما می‌دهد.
- توجه: یوتیوب اغلب آدرس‌های سرورهای ابری را مسدود می‌کند؛ برای دانلود یوتیوب بهتر است سرور اختصاصی داشته باشید.
